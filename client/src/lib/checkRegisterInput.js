...
// Register: email, password, passwordCheck
// Login: email, password
// PasswordReset: email
// NewPassword: password, passwordCheck
...
export default function checkRegisterInput({ email, password, passwordCheck }) {
  ...
  if (!checkPassword(password)) {
    return {
      result: false,
      msg:
        'Password needs a uppercase letter, a lowercase letter, a number and min. 8 characters.',
    }
  }
